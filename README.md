...
シーザー暗号、ヴィジュネル暗号、――これらの古典暗号は、今では実用されることはありませんがその仕組みや考え方を学ぶのはとても楽しいです。

このアプリは、様々な古典暗号のエンコード/デコードを行うことが出来ます。

私の勉強として以下のようなことに重点を置いて開発しています。
...
今後も機能を増やしていく予定です。もちろん、プルリクエストも歓迎です。
